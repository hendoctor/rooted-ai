...
// Public VAPID key used for subscribing to web push notifications
// This should be a base64url encoded, uncompressed EC public key generated by the
// `generate-vapid-keys` edge function. Earlier versions prepended an extra "B"
// character which resulted in an invalid key length (66 bytes instead of 65).
// Ensure the value does not include that prefix.
