    ...
    <section id="contact" className="py-20 bg-sage/5 dark:bg-slate-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {/* Contact Form */}
          <AnimatedSection animation="animate-slide-up">
            <Card className="border-sage/30 shadow-lg h-full flex flex-col card-energy">
          ...
          <div className="space-y-8">
            ...
            <AnimatedSection animation="animate-slide-up" delay={100}>
              <Card className="border-sage/30 dark:bg-slate-900 shadow-lg card-energy">
            ...
            <AnimatedSection animation="animate-slide-up" delay={200}>
              <Card className="border-forest-green/30 bg-forest-green/5 dark:bg-slate-900 shadow-lg card-energy">
                <CardContent className="p-8 text-center">
                  ...
                  <Button className="button-energy bg-earth-brown dark:bg-[hsl(24_25%_38%)] hover:bg-earth-brown/90 dark:hover:bg-[hsl(24_25%_33%)] text-white px-6 py-3 rounded-lg">
            ...
            <AnimatedSection animation="animate-slide-up" delay={300}>
              <Card className="border-sage/30 shadow-lg card-energy">
                <CardContent className="p-8">
                  <h3 className="text-xl font-semibold text-forest-green mb-4">
                    Stay Updated
                  </h3>
                  <p className="text-slate-gray mb-4">
                   ...
                   <form onSubmit={handleNewsletterSubmit} className="flex space-x-2">
                    ...
                    <Button
                      ...
                      className="button-energy bg-forest-green hover:bg-forest-green/90"
                    >
