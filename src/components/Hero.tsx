...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-cream/68 via-cream/45 to-transparent dark:from-background/60 dark:via-background/30 dark:to-transparent"></div>
      <div className="absolute inset-0 bg-forest-green/5 dark:bg-forest-green/6"></div>
