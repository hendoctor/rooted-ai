-- Enhance invitation token validation security
-- Add IP-based rate limiting and remove case-insensitive fallbacks

-- Update validate_invitation_secure function to be strictly case-sensitive
