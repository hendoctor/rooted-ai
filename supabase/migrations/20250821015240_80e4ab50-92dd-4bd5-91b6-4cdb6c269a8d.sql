...
CREATE POLICY IF NOT EXISTS "Admins manage announcement assignments"
ON public.announcement_companies FOR ALL
USING (is_admin())
WITH CHECK (is_admin());

-- Client read policy
CREATE POLICY IF NOT EXISTS "Clients read assigned announcements"
...
CREATE POLICY IF NOT EXISTS "Admins manage resource assignments"
ON public.portal_resource_companies FOR ALL
USING (is_admin())
WITH CHECK (is_admin());

CREATE POLICY IF NOT EXISTS "Clients read assigned resources"
...
CREATE POLICY IF NOT EXISTS "Admins manage useful links"
ON public.useful_links FOR ALL
USING (is_admin())
WITH CHECK (is_admin());

CREATE POLICY IF NOT EXISTS "Admins manage useful link assignments"
ON public.useful_link_companies FOR ALL
USING (is_admin())
WITH CHECK (is_admin());

CREATE POLICY IF NOT EXISTS "Clients read assigned useful links"
...
CREATE POLICY IF NOT EXISTS "Admins manage adoption coaching"
ON public.adoption_coaching FOR ALL
USING (is_admin())
WITH CHECK (is_admin());

CREATE POLICY IF NOT EXISTS "Admins manage adoption coaching assignments"
ON public.adoption_coaching_companies FOR ALL
USING (is_admin())
WITH CHECK (is_admin());

CREATE POLICY IF NOT EXISTS "Clients read assigned adoption coaching"
...
CREATE POLICY IF NOT EXISTS "Admins manage report assignments"
ON public.report_companies FOR ALL
USING (is_admin())
WITH CHECK (is_admin());

CREATE POLICY IF NOT EXISTS "Clients read assigned reports"
...
CREATE POLICY IF NOT EXISTS "Admins manage faqs"
ON public.faqs FOR ALL
USING (is_admin())
WITH CHECK (is_admin());

CREATE POLICY IF NOT EXISTS "Admins manage faq assignments"
ON public.faq_companies FOR ALL
USING (is_admin())
WITH CHECK (is_admin());

CREATE POLICY IF NOT EXISTS "Clients read assigned faqs"
