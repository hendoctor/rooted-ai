-- Create trigger function to automatically create company and membership for new client users
...
DROP TRIGGER IF EXISTS ensure_client_company_membership_trigger ON users;
CREATE TRIGGER ensure_client_company_membership_trigger
  AFTER INSERT ON users
  FOR EACH ROW
  EXECUTE FUNCTION ensure_client_company_membership();