-- Drop any existing session_status constraint
ALTER TABLE adoption_coaching DROP CONSTRAINT IF EXISTS adoption_coaching_session_status_check;

-- Update all existing records to use valid status values
...
-- Add the constraint for session_status  
