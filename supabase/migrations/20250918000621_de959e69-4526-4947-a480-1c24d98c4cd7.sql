-- Security Hardening: Fix RLS Policies to Address Critical Vulnerabilities (CORRECTED)
...
CREATE POLICY "Deny non-admin authenticated access to contact submissions" 
ON public.contact_submissions 
FOR SELECT 
TO authenticated 
USING (is_admin());
...
INSERT INTO public.security_audit_log (
  ...
  'security_hardening_migration_corrected',
  jsonb_build_object(
